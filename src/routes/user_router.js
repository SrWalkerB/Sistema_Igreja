...
user_route.put("/congregacao/membros/:id_membro", Autorizacao, User_Controllers.update_membro_congregacao);

user_route.put("/congregacao/info/", Autorizacao, User_Controllers.update_Info_Congregacao);
